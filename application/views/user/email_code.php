          ...
          <table width="70" align="left" border="0" cellpadding="0" cellspacing="0">  
            <tr>
              <td height="70" style="padding: 0 20px 20px 0;">
                ...
                <img class="fix" src="http://machinemanagement.asiagalaxy.com/src/material/global/assets/images/logo-no-background.png" width="70" height="70" border="0" alt="" />
              </td>
            </tr>
          </table>
          <!--[if (gte mso 9)|(IE)]>
          ...
          <table width="100%" border="0" cellspacing="0" cellpadding="0">
            <tr>
              <td align="center" class="footercopy">
                &reg; <?=date("Y")?> PT. Galaksi Investasi Harapan<br/>
