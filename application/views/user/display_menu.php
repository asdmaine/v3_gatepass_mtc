        ...
        <div class="panel-body container-fluid" style="padding: 0px;">
          <div class="panel">
              <div class="panel-body container-fluid">
                ...
                <?php if ($get_detail_menu->menu_level == 0) { ?>
                  <header class="panel-heading" style="text-align: center;">
                    <h3>Display Menu Level 0</h3>
                  </header>
                        ...
                        <div class="example">
                          ...
                          <!-- <?= form_open(base_url('backend/user/save_menu'),  'id="login_validation" enctype="multipart/form-data"') ?>
                            ...
                            <div class="form-group row">
                              ...
                              <div class="col-md-9">
                                <input type="text" required="required" class="form-control" value="<?=$get_detail_menu->menu_name?>" placeholder="Name Menu" autocomplete="off" disabled="disabled"/>                            
                              </div>
                            </div>
                ...
                <?php if ($get_detail_menu->menu_level == 1) { ?>
                  <header class="panel-heading" style="text-align: center;">
                        ...
                        <div class="example">
                          ...
                          <!-- <?= form_open(base_url('backend/user/save_menu'),  'id="login_validation" enctype="multipart/form-data"') ?>
                            ...
                            <div class="form-group row">
                              ...
                              <div class="col-md-9">
                                <input type="text" required="required" class="form-control" value="<?=$get_detail_menu->menu_url?>" placeholder="Name URL" autocomplete="off" disabled="disabled"/>                            
                              </div>
                            </div>
                ...
                <?php if ($get_detail_menu->menu_level == 2) { ?>
                  <header class="panel-heading" style="text-align: center;">
                ...
                <?php if ($get_detail_menu->menu_level == 3) { ?>
                  <header class="panel-heading" style="text-align: center;">
